...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Edward Ogheneochuko
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a Developer with strong expertise in building modern, responsive web applications using React, TypeScript, Next.js, and Tailwind CSS </p>
